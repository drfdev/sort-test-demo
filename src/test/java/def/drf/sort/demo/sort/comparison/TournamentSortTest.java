...
public class TournamentSortTest {
    private TournamentSort<Integer> sort;
    ...
    public void testSort() {
        sort = new TournamentSort<Integer>(Comparator.naturalOrder());
    ...
    public void testWithBigArray() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            SimpleMetricBucket bucket = SimpleMetricBucket.builder()
                    ...
                    .build();
            sort = new TournamentSort<Integer>(Comparator.naturalOrder(), bucket);
